...
export function TypeCard({
  ...
  return (
    <article
      ...
      className={cn(
        "card-shimmer cursor-pointer overflow-hidden rounded-2xl border transition-all duration-300",
        "fade-in-up",
        selected
    ...
    >
      <div className="flex h-48 items-center justify-center border-b border-white/10 bg-neutral-950">
      ...
      <div className="p-6">
        ...
        <div className="mb-5 flex items-center gap-4 border-y border-white/10 py-4">
          {stats.map((stat, i) => (
            <>
              {i > 0 && (
                <div key={`div-${i}`} className="h-8 w-px bg-white/10" />
              )}
